                ...
                <tr>
                    ...
                    <td>
                        @if ($user->id == Auth::user()->id)
                            ...
                            @else
                            <a href="/Administradores/{{$user->id}}/editar" class="btn btn-warning">Editar</a> <a href="/Administradores/usuarios/{{$user->id}}/destroy" class="btn btn-danger"  id="delete">Eliminar</a>
                        @endif
                    </td>
                </tr>
            @endforeach
